...
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.freecodecamp.org/news/content/images/size/w2000/2022/02/Banner-10.png', N'Giới thiệu về Python', N'Khóa học này giới thiệu cách sử dụng ngôn ngữ lập trình Python.', CAST(N'2023-01-01' AS Date), N'Nguyễn Văn A', 18000, 1, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://gisgeography.com/wp-content/uploads/2022/01/Artificial-Intelligence-Courses-Feature.png', N'Trí tuệ nhân tạo cho người mới bắt đầu', N'Khóa học cung cấp kiến thức cơ bản về trí tuệ nhân tạo.', CAST(N'2023-02-01' AS Date), N'Trần Thị B', 25000, 1, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/10/React-JS-BCG-Banner.png', N'Phát triển ứng dụng di động với React Native', N'Học cách xây dựng ứng dụng di động đa nền tảng với React Native.', CAST(N'2023-03-01' AS Date), N'Lê Văn C', 30000, 2, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://leverageedu.com/blog/wp-content/uploads/2021/08/Best-Blockchain-Courses-800x500.png', N'Giới thiệu về Blockchain', N'Tìm hiểu về công nghệ Blockchain và các ứng dụng của nó.', CAST(N'2023-04-01' AS Date), N'Phạm Thị D', 20000, 1, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://ccweb.imgix.net/https%3A%2F%2Fwww.classcentral.com%2Freport%2Fwp-content%2Fuploads%2F2017%2F10%2Fjs-and-frameworks-banner.png?auto=format&h=300&ixlib=php-4.1.0&s=4486df73054faf8345d0b8f69a791187', N'Lập trình Web với JavaScript, HTML và CSS', N'Khóa học này giúp bạn nắm vững kiến thức cơ bản về lập trình web.', CAST(N'2023-05-01' AS Date), N'Đặng Văn E', 27000, 1, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.freecodecamp.org/news/content/images/2022/01/machine-learning-banner-2.png', N'Machine Learning cơ bản', N'Khóa học giúp bạn tìm hiểu về machine learning và các thuật toán cơ bản.', CAST(N'2023-06-01' AS Date), N'Huỳnh Văn F', 32000, 2, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://i.ytimg.com/vi/2yXfUPwlZTw/maxresdefault.jpg', N'Phát triển ứng dụng Web với Django', N'Học cách xây dựng ứng dụng web mạnh mẽ với Django.', CAST(N'2023-07-01' AS Date), N'Ngô Thị G', 35000, 2, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/06/SQL-BCG-Banner-2.png', N'Tối ưu hóa SQL', N'Tìm hiểu về cách tối ưu hóa truy vấn SQL và cải thiện hiệu suất.', CAST(N'2023-09-01' AS Date), N'Lý Thị I', 22000, 3, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://img-c.udemycdn.com/course/750x422/1210008_6859.jpg', N'Lập trình game với Unity', N'Khóa học này giúp bạn nắm vững kiến thức cơ bản về lập trình game với Unity.', CAST(N'2023-10-01' AS Date), N'Phan Văn J', 40000, 1, 1)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://images.careerbuilder.vn/content/images/ui-ux-careerbuilder.jpg', N'UI/UX Design cơ bản', N'Khóa học giúp bạn tìm hiểu về thiết kế giao diện và trải nghiệm người dùng.', CAST(N'2023-11-01' AS Date), N'Mai Văn K', 24000, 1, 2)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/05/Adobe-Photoshop-BCG-Banner-1.png', N'Thiết kế đồ họa với Adobe Photoshop', N'Học cách sử dụng Adobe Photoshop để tạo ra các sản phẩm đồ họa chuyên nghiệp.', CAST(N'2023-12-01' AS Date), N'Bùi Thị L', 30000, 1, 2)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/05/Sketch-Banner.png', N'Thiết kế sản phẩm với Sketch', N'Khóa học giới thiệu về Sketch và cách sử dụng công cụ này để thiết kế sản phẩm.', CAST(N'2024-01-01' AS Date), N'Vũ Văn M', 27000, 2, 2)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/05/Figma-Banner-2.png', N'Thiết kế Web với Figma', N'Tìm hiểu về cách thiết kế giao diện web chuyên nghiệp với Figma.', CAST(N'2024-02-01' AS Date), N'Phạm Thị N', 26000, 2, 2)
INSERT [dbo].[Courses] ([CourseBannerImage], [Title], [CourseDescription], [PublishDate], [Lecturer], [DurationInSeconds], [SemesterID], [CategoryID]) VALUES (N'https://www.classcentral.com/report/wp-content/uploads/2022/06/Adobe-Illustrator-BCG-Banner.png', N'Thiết kế đồ họa với Adobe Illustrator', N'Khóa học này giúp bạn nắm vững kiến thức cơ bản về thiết kế đồ họa với Adobe Illustrator.', CAST(N'2024-03-01' AS Date), N'Đặng Văn O', 32000, 1, 2)
GO
